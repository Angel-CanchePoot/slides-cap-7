...
<section>
    ...
    <div style="overflow: auto; width: 300px; height: 100px"></div>
    <p>
...
Fibra óptica: Utiliza luz para transmitir datos a través de un núcleo de vidrio o plástico, ofreciendo alta capacidad de ancho de banda y resistencia a interferencias.</p>
    </p>
...
<section id="themes">
    ...
    <p>
        ...
        <a href="#" onclick="document.getElementById('theme').setAttribute('href','css/theme/black.css'); return false;">Green (default)</a> -
